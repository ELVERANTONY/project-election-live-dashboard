  ...
  return (
    <main className="flex-1 overflow-y-auto">
      <div className="px-4 md:px-8 lg:px-12 py-6 max-w-5xl mx-auto">
        ...
        <footer className="mt-16 pb-8 border-t border-outline-variant/10 pt-8 flex flex-col items-center gap-2 text-center">
          <p className="font-label text-xs text-on-surface-variant/60 tracking-wide">
